...
import config
from Cherry import Apple, Resso, SoundCloud, Spotify, Telegram, YouTube, app
from Cherry.core.call import Cherry
from Cherry.utils import seconds_to_min, time_to_seconds
from Cherry.utils.channelplay import get_channeplayCB
from Cherry.utils.decorators.language import languageCB
from Cherry.utils.decorators.play import PlayWrapper
from Cherry.utils.formatters import formats
from Cherry.utils.inline import (
    botplaylist_markup,
    livestream_markup,
    playlist_markup,
    slider_markup,
...
from Cherry.utils.logger import play_logs
from Cherry.utils.stream.stream import stream
...
@app.on_callback_query(filters.regex("CherrymousAdmin") & ~BANNED_USERS)
async def Cherrymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("CherryPlaylists") & ~BANNED_USERS)
@languageCB
